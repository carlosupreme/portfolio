...
export default function CopyEmail() {
    ...
    return (
        <button
            ...
            className="disabled:opacity-50 dark:disabled:ring-0 px-2.5 py-2 border border-dark-border rounded-lg text-sm dark:text-white cursor-pointer dark:hover:ring-4 dark:hover:ring-dark-profound transition-all">
